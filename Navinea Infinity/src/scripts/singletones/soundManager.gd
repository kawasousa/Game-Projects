...
var sfx: Dictionary = {
	"explosion": {
		"path": "res://src/assets/sounds/sfx/8- bit explosion.mp3",
		"volume": -10
	},
	"damage": {
		"path": "res://src/assets/sounds/sfx/8-bit hit.mp3",
		"volume": 24
	},
	"shoot": {
		"path": "res://src/assets/sounds/sfx/8bit shoot.MP3",
		"volume": -5
	}
};
...
var musics: Dictionary = {
	"menu": {
		"path": "res://src/assets/sounds/musics/Swan Lake Theme.mp3",
		"volume": -10
	},
	"menu2": {
		"path": "res://src/assets/sounds/musics/music menu 2.MP3",
		"volume": -10
	}
};
