...
var asteroids: Array[PackedScene] = [
	preload("res://src/scenes/entities/big_asteroid.tscn"),
	preload("res://src/scenes/entities/little_asteroid.tscn")
]
...
func _ready() -> void:
	...
	if Global.canShowTutorial:
		Global.showTutorial()
		await Global.tutorialFinished
...
func spawnAsteroid() -> void:
		...
		var spawnX = randf_range(bottom_spawn_marker.global_position.x, top_spawn_marker.global_position.x);
		var spawnY = randf_range(bottom_spawn_marker.global_position.y, top_spawn_marker.global_position.y);
